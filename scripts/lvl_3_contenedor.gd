...
func _ready() -> void:
	hp = 1 
	print("Contenedor del Nivel 3 listo con ", hp, " HP")

# porcentaje de drops sean diferentes, 
func generar_bonificacion() -> void:
	...
	if roll_tipo < 20 and escena_rango != null:
		...
		print("Drop Nivel 3: Bonificación de Rango (20% p)")
	...
	# Antes Velocidad era entre 40 y 70 (30% p). Ahora entre 20 y 45 (25% p).
		...
		print("Drop Nivel 3: Bonificación de Velocidad (25% p)")
	...
	# Añadimos un límite para que el 40% restante de las veces (de 60 a 100) NO suelte nada.
		...
		print("Drop Nivel 3: Bonificación de Cargas (15% p)")
	else:
		print("Drop Nivel 3: El contenedor estaba vacío (40% p de no drop)")
